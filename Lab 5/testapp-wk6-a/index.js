...
// Get most 15 watched movies
app.get("/most-watched", async (request, response) => {
  let mostWatchedShows = await trakt.getMostWatchedShows();
  response.render("most-watched", { title: "Top 15 Most Watched Shows", shows: mostWatchedShows });
});

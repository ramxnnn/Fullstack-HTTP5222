...
async function getMostWatchedShows() {
  let reqUrl = `${trakt}/shows/watched/period?limit=15&extended=full`; // Added limit parameter to show 15 movies only.
  let response = await fetch(
    reqUrl,
    {
      method: "GET",
...
module.exports = {
  getTrendingMovies,
  getStudiosByMovieId,
  getMostWatchedShows // added the function here to export
};